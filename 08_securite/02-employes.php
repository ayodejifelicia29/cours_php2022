<?php 
   ...
   $pdoENT->exec("SET NAMES UTF8");
    ...
    if(!empty($_POST)){
        // pour se prémunir des failles nous faison ceci
        ...
        $request=$pdoENT->prepare("INSERT INTO employes (prenom, nom, sexe, service, date_embauche, salaire) VALUES (:prenom, :nom, :sexe, :service, :date_embauche, :salaire)");
        // Now();
...
<body class="bg-light">
    ...
    <div class="jumbotron bg-dark text-white text-center">
        <h1 class="display-3">Cours_PHP2022 - Entreprise et employes</h1>
        ...
        <div class="col-sm-8">
            <main class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <?php
                        $request=$pdoENT->query("SELECT * FROM employes ORDER BY Prenom");

                        $nbr_employes=$request->rowCount();

                        echo "<p>Il y a "  .$nbr_employes. " employès dans la BDD.</p>";
