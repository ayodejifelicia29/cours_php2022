<?php
//Une prémiére fonction
function minpap(){
    echo"<p class=\"lead\">Minute !</p>";
}
...
function quelJour(){
 ...
 function jevar_dump($mavariable){ // la fonction nommée avec son paramètre: une variable qu'on 
    //va pouvoir modifier pour mettre le nom de celle qu'on veut afficher
