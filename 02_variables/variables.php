        ...
        <div class="col-sm-8">
            <main class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <p> L'affectation consiste à donner une valeur à une variable. Lors de la création variable, vous ne déclarez pas son type.C'est la valeur que vous lui affectez qui détermine ce type.Dans PHP, vous pouvez affecter une variable par valeur ou par référence.</p>
                        <ul>
                            <li>$mavar=75;</li>
                            <li>$mavar="Paris";</li>
                ...
                <hr>
                <div class="row">
                    <h2 class="text-center col-sm-12" id="variablesPredefines"> <u>3-Les variables predéfinies</u></h2>
                    <div class="col-sm-12">
                        <p> Le PHP dispose d'un grand nombre de variable prédéfinies qui contiennent des information à la fois sur le serveur et sur toutes les données qui peuvent transiter entre le poste client et le serveur, comme les autres valeurs saisies dans un formulaire, les cookies ou les sessions.</p>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Contient le nom et des variables d'environnements qui sont changeantes selon les les serveurs</td>
                                </tr>
                                <tr>
                                    <th scope="row">$_FILES</th>
                                    <td>Contient le nom et des fichiers téléchargés à partir du poste clients</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Contient les informatins liées au serveur web, tel le contenu des en-têtes HTTP ou le nom du script en cours d'execution.Retenues les variables suivantes :
                                        <ul>
                                            <li><code>$_SERVER["HTTP_ACCESS_LANGUAGE"]</code>, qui contient le code de langue du navigateur client</li>
                                            <li>>$_SERVER["HTTP_COOKIE"]</code>, qui contient le nom et la valeur des cookies lus sur le poste client</li>
                                            <li>>$_SERVER["HTTP_HOST"]</code>, qui donnée le nom de domaine</li>
                                            <li>>$_SERVER["PHP_SELF"]</code>, qui contient le nom du script en cours. Nous l'utiliserons souvent dans les formulaires</li>
                                            <li>>$_SERVER["SERVER_ADDR"]</code>, qui indique l'adresse IP du serveur.
                                            </li>
                                            <li>>$_SERVER["QUERY_STRING"]</code>, qui contient la chaine de la requête utilisée pour accéder au script</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
