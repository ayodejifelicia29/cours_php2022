        ...
        <div class="col-sm-8 col-md-9 col-lg-9">
            <main class="container-fluid">
              ...
              <div class="col-sm-12 px-4">
                ...
                <p>Dans PHP, il n'existe pas de déclaration explicite du type d'une variable lors de sa création. 
                    Même PHP 7 reste un langage pauvrement typé comparé à Java ou au C. </p>
                </div><!--  fin de la colonne -->
                <div class="col-sm-12">
                    ...
                    <ul>
                        ...
                        <li>Booléens, avec le type boolean, qui contient les valeurs de vérité TRUE ou FALSE 
                            (soit les valeurs 1 ou 0 si on veut les afficher).</li>
                        </ul>
                ...
                <div class="col-sm-12 col-md-9">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">%</th>
                                <td>Modulo : reste de la division du premier opérande par le deuxième. Fonctionne aussi 
                                    avec des opérandes décimaux. Dans ce cas, PHP ne tient compte que des parties entières 
                                    de chacun des opérandes.
                            ...
                            <tr>
                                <th scope="row">--</th>
                                <td>Décrémentation: soustrait une unité à la variable. Il existe deux possibilités, 
                                la prédécrémentation, qui soustrait avant d'utiliser la variable, et la postdécrémentation, 
                                qui soustrait après avoir utilisé la variable.<br>
                                $var=56;<br>
                            ...
                            <tr>
                                <th scope="row">++</th>
                                <td>Incrémentation : ajoute une unité à la variable. Il existe deux possibilités, 
                                 la préincrémentation, qui ajoute 1 avant d'utiliser la variable, et la postincrémentation, 
                                   qui ajoute 1 après avoir utilisé la variable.
                                
                                <?php
                                $var=56;
                                echo "<br><div class=\" alert alert-success w-50\">". $var++ ." et, avec post-incrémentation = ". $var 
                                . "<br> Avec la pré-incrémentation = ". ++$var ."</div>";
                                ?>
                                </td>
                             </tr>     
                        </tbody>
                       </table>
                     </div> <!-- fin de la colonne (row)-->
                 ...
                 <div class="col-sm-12 col-md-3">
                    ...
                    $a = 89;
                    $b = ($a<100);
                    echo "<p class=\"alert alert-success\">La variable \$a qui vaut $a est-elle inférieure à 100 ? 
                    La réponse est " . $b ."</p>";
                    ?>
                    <p>Ici la variable $b nous renvoie le booléen 1 qui signifie vrai. 
                        Dans le cas où la variable doit renvoyé un booléen faux (False), il y aura une chaîne vide à la place de 0.</p>
                </div> <hr>

                 <div class="col-sm-12">
                    <h3 class="text-center">C. Les opérateurs booléens</h3>
                    <p>Quand ils sont associés, les opérateurs booléens servent à écrire des expressions simples ou complexes, 
                        qui sont évaluées par une valeur booléenne TRUE ou FALSE. Ils seront utilisés dans 
                        les instructions conditionnelles.</p>
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th scope="col">Opérateur</th>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">==</th>
                                <td>
                                Teste l'égalité de deux valeurs. L'expression $a == $b vaut TRUE si la valeur de $a 
                                est égale à celle de $b et
                                FALSE dans le cas contraire :<br>
                                $a = 345;<br>
                                $b = "345";<br>
                                $c = ($a==$b);<br>
                                $c est un booléen qui vaut TRUE car dans un contexte de comparaison numérique, la chaîne "345" est
                                évaluée comme le nombre 345. Si $b="345 éléphants" nous obtenons le même résultat.
                                 </td>
                            </tr>
                            <tr>
                                <th scope="row">!= ou &lt;></th>
                                ...
                                L'expression $a != $b vaut TRUE si la valeur de $a est différente de celle de $b et FALSE 
                            ...
                            <tr>
                                ...
                                $b sont du même type (mais à condition que ces deux valeur aient le même type). Elle vaut FALSE dans 
                                le cas contraire :<br>
                                $a = 345;<br>
                                $b = "345";<br>
                                $c = ($a===$b);<br>
                                $c est un booléen qui vaut FALSE car si les valeurs sont égales, les types sont différents 
                                (integer et string).
                                </td>
                            </tr>
                            <tr>
                                ...
                                L'expression $a !== $b vaut TRUE si la valeur de $a est différente de celle de $b ou si $a 
                                et $b  et que leurs types sont différent. Dans le cas contraire, elle vaut FALSE :<br>
                                $a = 345;<br>
                                $b = "345";<br>
                                $c = ($a!==$b);<br>
                                $c est un booléen qui vaut TRUE car si les valeurs sont égales, les types sont différents 
                                (integer et string).
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th scope="row">&lt;=></th>
                                <td>
                                Avec $a=>$b, retourne -1, 0 ou 1 respectivement si $a<$b, $a=$b ou $a>$b 
                                ($a et $b peuvent être des chaînes).
                                </td> 
                             </tr>
                          </tbody>
                      </table>
                 ...
                 <div class="col-sm-12">
                    ...
                    <p>Attention, une erreur classique dans l'écriture des expressions conditionnelles consiste à confondre 
                        l'opérateur de comparaison == avec l'opérateur d'affectation =. L'usage des parenthèses dans 
                        la rédaction des expressions booléennes est souvent indispensable et toujours recommandé pour 
                        éviter les problèmes liés à l'ordre d'évaluation des opérateurs.</p>
                </div><!-- fin de la colonne -->
            </div><!-- fin de la rangée -->
            <hr>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>Les chaînes de caractères sont avec les nombres les types de données les plus manipulés sur un site web. 
                        De surcroît, dans les échanges entre le client et le serveur au moyen de formulaires, toutes les donnée 
                        sont transmises sous forme de chaînes, d'où leur importance.</p>
                    <p>Une chaîne de caractères est une suite de caractères alphanumériques contenus entre des guillements simples 
                    (apostrophes) ou doubles. Si une chaine contient une variable, celle-ci est évaluée et sa valeur incorporée à
                        la chaîne uniquement si vous utilisez des guillement et non des apostrophes. <br></p>
                    <?php
                        $vartest = "coucou";
                        echo "<p class=\"alert alert-success w-75 text-center mx-auto\">Je dis $vartest !</p>";
                        
                        var_dump($vartest); //var_dump affiche les informations structurées d'une variable,y compris son type et sa valeur.
                    ?>
                    <ul>
                        <li>$a = 'PHP';</li>
                        <li>$b = 'MySQL';</li>
                        <li>$c = "PHP et $b";//affiche : PHP et MySQL</li>
                        <li>$d = 'PHP et $b'; //affiche PHP et $b car $ et b sont considérés comme des caractères 
                            sans signification particulière</li>
                    </ul>
                    <?php
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Séquence de caractères désignant un nombre octal (de 1 à 3 caractères 0 à 7) 
                                    et affichant le caractère correspondant :
                                echo "\115\171\123\121\114"; //Affiche MySQL.</td>
                            </tr>
                            <tr>
                                <th scope="row">\x[0-9 A-F a-f] {1,2}</th>
                                <td>Séquence de caractères désignant un nombre hexadécimal (de 1 à 2 caractères 0 à 9 et A à F ou a à f) 
                                    et affichant le caractère correspondant :<br> echo "\x4D\x79\x53\x51\x4C"; // Affiche MySQL</td>
                               </tr>
                        </tbody>
                    </table>
                    <hr>
                    ...
                    <p>L'opérateur PHP de concaténation est le point(.), qui fusionne deux chaînes littérales 
                        ou contenues dans des variables en une seule chaîne.</p>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <p>Les tableaux représentent un type composé car ils permettent de stocker sous un même nom de variable plusieurs 
            valeurs indépendantes d'un des types de base que vous venez de voir. C'est comme un tiroir divisé en compartiments. 
            Chaque compartiment, que nous nommerons un élément du tableau, est repéré par un indice numérique (le premier ayant par défaut 
            la valeur 0 et non 1). D'où l'expression de tableau indicé.</p><p>Un tableau appelé array en anglais, est une variable améliorée 
                dans laquelle on stocke une multitude de valeurs. Ces valeurs peuvent être de n'importe quel type. 
        ...
        <?php
            ...
            echo "<p class=\"alert alert-success w-50 mx-auto\">Nombre d'élements du tableau : ". COUNT($tab). ".<br>Le langage préféré de 
            l'open source est $tab[2].
             <br> Utilisez $tab[35].</p>";  
             var_dump($tab);
             print_r($tab);
        ?>
        </blockquote>
