...
<body class="bg-dark">
    ...
    <div class="jumbotron  text-center">
        ...
        <p class="lead bg-light">On retrouve dans PHP la plupart des instructions de contrôle des scripts.
            Indispensables à la gestion du déroulement d'un algorithme quelconque, ces instructions
            sont présentes dans tous les langages. PHP utilise une syntaxe très proche de celle du langage C.
            Ceux qui ont déjà pratiqué un langage tel que le C ou plus simplement JavaScript seront en pays de
            connaissance.</p>
    </div>
    ...
    <div class="row bg-light">
        ...
        <div class="col-sm-8">
            <main class="container-fluid bg-light">
                ...
                <div class="row">
                    <hr>
                    <h2 class="col-sm-12 text-center" id="condtions"><u>1 - Les conditions avec if</u></h2>
                    <div class="col-sm-12 col-md-4" id="if">
                        <h3 class="text-center">1 - if</h3>
                        <p>L'instruction <code>if</code> est la plus simple et la plus utilisée des instructions
                            conditionnelles.
                            Présente dans tous les langages de programmation, elle est essentielle en ce qu
                            'elle permet d'orienter l'exécution
                        ...
                        if ($a > $b && $b > $c) {
                            echo "<p class=\"alert alert-success w-75 mx-auto text-center\">Les deux 
                            conditions sont respectées.</p>";
                        }
                        ?>
                    ...
                    <div class="col-sm-12 col-md-4" id="ifElse">
                        ...
                        <p>L'instruction <code>if... else</code> permet de traiter le cas où l'expression
                            conditionnelle est TRUE et en même temps d'écrire un traitement de rechange quand elle
                            est évaluée à FALSE,
                            ce que ne permet pas une instruction if seule. L'instruction ou le bloc qui suit
                            <code>else</code> est alors
                            le seul à être exécuté. L'exécution continue alors ensuite normalement après le bloc
                            <code>else</code>.
                        </p>
                        <?php
                        if ($a > $b) {
                            echo "<p class=\"alert alert-success w-75 mx-auto text-center\">$a est supérieur
                                 à $b.</p>";
                        } else {
                            echo "<p class=\"alert alert-success w-75 mx-auto text-center\">$b est supérieur
                                 à $a</p>";
                        }
                        ?>
                    ...
                    <div class="col-sm-12 col-md-4" id="ifElseIfELSE">
                        ...
                        <p>Nous aurons ici une syntaxe un peu plus compliquée de la forme suivante : <code>
                                if (condition) {} else if (condition) {} else {}</code></p>
                        <p>Ici, notre variable d est égale à 8. On teste différentes conditions pour voir laquelle
                            est vraie grâce à un <code>if... else if... else.</code>. Ici c'est la première condition
                            qui est vraie.</p>
                        <?php
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>Il existe d'autres façons d'écrire un if else : la méthode ternaire. Avec cette méthode,
                            le code sera le suivant : <code>(condition) ? code a exécuter si la condition retourne
                                TRUE : code à retourner si le code renvoie FALSE;</code></p>
                        <?php
                        $h = 10;
                        // en ternaire 
                        echo ($h == 10) ? "<p class=\"alert alert-success w-75 mx-auto text-center\">\$h est égal à
                            10.</p>"
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>Switch permet de comparer à une multitude de valeurs, comme l'instruction
                            <code>if.. else if... else if... else</code>.
                        </p>
                        <?php
                        echo "<p class=\"alert alert-success w-75 mx-auto text-center\">";
                        $dept = 75;
                        switch ($dept) {
                            ...
                            case 91:
                                ...
                                break;
                            default:
                                echo "Département inconnu !!! Revoyez vos cours de Géo la département 100 n'existe pas";
                                break;
                        }
                        echo "</p>";
                        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>La boucle <code>while</code> permet d'affiner le comportement d'une boucle en
                            réalisant une action de manière répétitive tant qu'une condition est vérifiée ou qu'une
                         expression quelconque est évaluée à TRUE et donc de l'arrêter quand elle n'est plus vérifiée,
                            évaluée à FALSE.</p>
                        <div class="alert alert-success w-75 mx-auto text-center">
                            <?php
                            $n = 1;
                            while ($n % 7 != 0) { // le script continue jusqu'à trouver un multiple de 7
                                $n = rand(1, 100); // rand fait un tirage de nombres aléatoires compris entre 1 et 100
                                /*  rand() pour random */
                                echo $n . "&nbsp; -  "; /* &nbsp; stands for "non-breaking space"*/
                            }
                            ?>
                        </div>
                    </div> <!-- fin de la colonne -->

                    <div class="col-sm-12 col-md-6" id="while">
                        <h3 class="text-center" id="dowhile">2 - Boucle do... while</h3>
                        <p>Avec l'instruction <code>do ... while</code>, la condition n'est évaluée
                         qu'après une première exécution des instructions du bloc compris entre do et while. </p>
                            <div class="alert alert-success w-75 mx-auto text-center">
                            <?php
                            $n2 = 1;
                            do {
                                ...
                                echo $n2 . "&nbsp; * ";
                            } while ($n2 % 7 != 0); // le script s'arrête lorsque l'on  un multiple de 7 
                            ?>
                        </div>
                    </div> <!-- fin de la colonne -->
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>La boucle <code>for</code> est plus concise, ramassée que la boucle <code>while</code>.
                            Elle s'écrit ainsi : <code>for(iniatialisation; condition; incrémentation)
                                { code à exécuter }</code></p>
                        <div class="alert alert-success w-75 mx-auto text-center">
                            <?php
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>La boucle <code>foreach</code> (pour chaque passage), est efficace pour afficher
                            et lister
                        ...
                        <div class="alert alert-success w-75 mx-auto text-center">
                            ...
                            foreach ($tab as $val) { // as(c'est comme) on passe dans $val le contenu de chacun 
                    ...
                    <div class="col-sm-12">
                        <p class="alert alert-danger w-50 mx-auto text-center">Lecture des indices et des valeurs
                            d'un tableau :<br>
                            <?php
