            ...
            <main class="container-fluid bg-light">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <p>Avec l'unstruction <code>do ... while</code>, la condition n'est évaluée
                         qu'après une première exécution
                    ...
                    <div class="col-sm-12">
                     <p class="alert alert-success w-50 mx-auto text-center">Lecture des indices et des valeurs 
                            d'un tableau :<br>
                        <?php 
